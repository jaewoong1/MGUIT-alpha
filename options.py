...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--input_b', type=str, default='rainy', help='domain B')
    ...
    # ouptput related
    self.parser.add_argument('--name', type=str, default='sunny_rainy2', help='folder name to save outputs')
    ...
    self.parser.add_argument('--n_ep', type=int, default=60, help='number of epochs') # 400 * d_iter
...
class TestOptions():
  def __init__(self):
    ...
    # output related
    self.parser.add_argument('--name', type=str, default='sunny_rainy', help='folder name to save outputs')
    self.parser.add_argument('--result_dir', type=str, default='results', help='path for saving result images and models')
    self.parser.add_argument('--save_dir', type=str, default='outputs', help='path for saving result images and models')

    # model related
    self.parser.add_argument('--resume', type=str, default='ckpt/00004.pth', help='specified the dir of saved models for resume the training')
    self.parser.add_argument('--gpu', type=int, default=1, help='gpu')
